...
\begin{figure}[tpb]
\centering
	\includegraphics[width=0.96\linewidth]{1.png} 
...
\begin{figure}[htpb]
\centering
	\includegraphics[width=0.96\linewidth]{3.png} 
...
\begin{figure}[tpb]
\centering
	\includegraphics[width=0.96\linewidth]{4.png} 
	\caption{Platform right view}\label{fig:scene}
	\vspace{-0.4cm}
\end{figure}
